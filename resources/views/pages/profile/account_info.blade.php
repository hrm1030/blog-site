            ...
            <form class="form" action="{{ route('profile.account_info.save') }}" method="POST" id="accout_form" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <select class="form-control form-control-lg form-control-solid" id="language" name="language">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <select class="form-control form-control-lg form-control-solid" id="time_zone" name="time_zone">
