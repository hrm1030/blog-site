        ...
        <div class="card-body pt-4">
            ...
            <div class="d-flex align-items-center">
                <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                    ...
                    @elseif(Auth::user()->photo == '' || Auth::user()->photo == null)
                        @php
                        ...
                        <div class="symbol symbol-50 symbol-light-{{ $color_array[$color] }}" flex-shrink-0>
                            <div class="symbol-label display-3">{{ ucwords(Auth::user()->username[0]) }}</div>
                        </div>
                    @endif
            ...
            @php
                ...
                if($urls[1] == 'personal_info')
                {
                    $personal_active = 'active';
                }
                if($urls[1] == 'account_info')
                {
                    $account_active = 'active';
                }
                if($urls[1] == 'change_password')
                {
            ...
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('profile.personal_info') }}" class="navi-link py-4 {{ $personal_active }}">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('profile.account_info') }}" class="navi-link py-4 {{ $account_active }}">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
