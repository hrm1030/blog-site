    ...
    <div class="col-xl-4">
        ...
        <div class="card card-custom gutter-b card-stretch">
            ...
            <div class="card-body">
                ...
                <!--end::Info-->
                <!--begin::Description-->
                <div class="mb-10 mt-5 font-weight-bold">{{ substr($university->description, 0, 200) }}...<br> <span class="text-primary read_more" university_id="{{ $university->id }}" style="cursor: pointer;">Read more</span></div>
                <!--end::Description-->
                <!--begin::Data-->
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="university_name"></h5>
