...
<script src="{{ asset('js/admin/management/professors.js') }}"></script>
...
<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
    ...
    Professor list can be managed by admin. Link <a href="{{ route('management.professors') }}" class="font-weight-bold">management/professors</a>
    </div>
</div>
<div class="card card-custom">
    <div class="card-header flex-wrap py-5">
        <div class="card-title">
            <h3 class="card-label">Professor Management
            ...
            <tbody>
                ...
                @endphp
                    <tr>
                        <td>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50 flex-shrink-0">
                                    <img src="{{ asset($professor->photo) }}" alt="photo">
                                </div>
                                <div class="ml-3">
                                    <span class="text-dark-75 font-weight-bold line-height-sm d-block pb-2">{{ $professor->fullname }}</span>
                                    <a href="#" class="text-muted text-hover-primary">{{ $professor->email }}</a><br>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-50 symbol-light-{{ $color_array[$color] }}" flex-shrink-0>
                                    <div class="symbol-label font-size-h5">{{ ucwords($professor->fullname[0]) }}</div>
                                </div>
                                <div class="ml-3">
                                    <span class="text-dark-75 font-weight-bold line-height-sm d-block pb-2">{{ $professor->fullname }}</span>
                        ...
                        <td>
                            <span class="font-weight-bolder text-danger">{{ $professor->university_name }}</span>/<span class="font-weight-bolder text-success">{{ $professor->faculty_name }}</span>/<span class="font-weight-bolder text-primary">{{ $professor->department_name }}</span>
                        </td>
                        <td>
                            {{ $professor->majors }}
                        </td>
...
<div class="modal fade" id="professorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Professor Edit</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
                <form class="form" action="{{ route('management.professor.save') }}" method="POST" enctype="multipart/form-data" id="professor_form">
                    @csrf
                    <input type="hidden" name="professor_id" id="professor_id">
                    <!--begin::Body-->
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 col-form-label">Professor Image <span class="text-danger">*</span></label>
                            <div class="col-lg-9 col-xl-6">
                                <div class="image-input image-input-outline" id="kt_professor_image" style="background-image: url({{ asset('assets/media/users/blank.png') }})">

                                    <div class="image-input-wrapper"></div>
                                    <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                        <i class="fa fa-pen icon-sm text-muted"></i>
                                        <input type="file" name="professor_image" accept=".png, .jpg, .jpeg" />
                                        <input type="hidden" name="professor_image_remove" />
                                    </label>
                        ...
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 col-form-label">Professor Name <span class="text-danger">*</span></label>
                            <div class="col-lg-9 col-xl-6">
